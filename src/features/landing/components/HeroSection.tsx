...
export const HeroSection: React.FC<HeroSectionProps> = ({ config, onStartBooking, onOpenLogin }) => (
  <section className="bg-[#07182b] text-white px-4 py-14 sm:py-16 lg:py-24">
    <div className="mx-auto max-w-6xl lg:grid lg:grid-cols-[1fr_280px] lg:items-end lg:gap-16">
      <div className="max-w-3xl">
        <p className="mb-4 flex items-center gap-2 text-xs font-bold uppercase tracking-[0.18em] text-[#c9975b]">
      ...
      <div className="mt-8 flex w-full flex-col gap-3 lg:mt-0">
        <button id="hero-book-now-btn" onClick={onStartBooking} className="flex min-h-12 w-full items-center justify-center gap-2 bg-[#c9975b] px-6 py-3 font-bold text-[#07182b] transition-colors hover:bg-[#d8aa72] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">
