-- Mantém a validação autoritativa do banco alinhada ao motor de agenda do cliente.
-- Configurações legadas sem weeklySchedule continuam usando daysOpen/open/close.
